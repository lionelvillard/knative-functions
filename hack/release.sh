...
github::create_release $GITHUB_TOKEN lionelvillard/knative-functions $TAG
github::upload_asset $GITHUB_TOKEN lionelvillard/knative-functions $TAG release/functions.yaml
